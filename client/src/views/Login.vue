  ...
  >
    <div class="w-full max-w-md px-6">
      ...
      <div class="text-center mb-10">
        <div
          class="inline-flex items-center justify-center w-12 h-12 rounded-lg mb-4"
      ...
      <div class="mb-8">
        ...
        <p class="text-center mb-6" style="color: #787774">
          欢迎使用财务记账系统
        </p>
        ...
        >
          <el-form-item prop="username">
            <el-input
              ...
              size="large"
              style="
                --el-input-bg-color: #f7f6f3;
                --el-input-border-color: #e9e9e7;
                --el-input-hover-border-color: #c9c9c7;
                --el-input-focus-border-color: #2eaadc;
              "
            />
          </el-form-item>
      ...
      <div class="space-y-3 text-center">
        <div>
          <el-link
            type="primary"
            @click="openRegister"
            style="color: #37352f; font-weight: 500"
            >创建账户</el-link
          >
        </div>
        <div>
        ...
        <el-form-item prop="email">
          <div class="flex gap-2">
            ...
            <el-button
              ...
              style="background: #f7f6f3; border-color: #e9e9e7; color: #37352f"
              @click="sendCode"
            >
    ...
    >
        ...
        >
          <el-form-item prop="email">
            <div class="flex gap-2">
              ...
              <el-button
                :loading="sendingCode"
                :disabled="!forgotPasswordForm.email || countdown > 0"
                style="
                  background: #f7f6f3;
                  border-color: #e9e9e7;
                  color: #37352f;
      ...
      <div v-else class="text-center py-6">
        ...
        >
          <el-icon :size="28" style="color: #37352f"
            ><CircleCheckFilled
          /></el-icon>
        </div>
        <p class="text-lg font-semibold mb-2" style="color: #37352f">
          密码已重置
        </p>
...
const sendForgotCode = async () => {
  ...
  forgotPasswordError.value = "";
  try {
    await axios.post("/api/auth/send-forgot-code", {
    ...
    forgotPasswordError.value =
      err.response?.data?.message || "发送失败，请稍后重试";
  } finally {
    sendingCode.value = false;
  }
};
...
const handleResetPassword = async () => {
  ...
  await forgotFormRef.value.validate(async (valid) => {
    ...
    try {
      ...
      forgotPasswordError.value =
        err.response?.data?.message || "重置失败，请检查验证码";
    } finally {
